...
class Solution31 {
    ...
    比如：12013，则可以知道百位出现1的情况可能是：0100~0199，1100~1199,2100~2199，，...，11100~11199，一共1200个。
    ...
    但同时它还受低位影响，百位出现1的情况是：12100~12113,一共14个，等于低位数字13+1。
    ...
    public static int NumberOf1Between1AndN_Solution(int n) {
        ...
        while ((n/i) != 0){
            current = (n / i) % 10;
            before = n / (i * 10);//获取当前位数之前的数
            after = n - (n / i) * i;//获取当前位数之后的数
            if(current == 0){
                count += before * i;
            }else if (current == 1){
